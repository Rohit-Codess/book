  ...
  const BookCard = ({ book }) => (
    ...
    >
      ...
      <div className="p-3 sm:p-4">
        <h3 className="truncate font-semibold text-sm sm:text-lg mb-1 line-clamp-2">{book.title}</h3>
        <p className="truncate text-gray-600 text-xs sm:text-sm mb-2">by {book.author}</p>
        ...
        <p className="truncate text-gray-600 text-xs sm:text-sm mb-3 line-clamp-2">{book.description}</p>
